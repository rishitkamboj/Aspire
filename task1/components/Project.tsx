...
Secure Authorization: SpeakUp utilizes JSON Web Tokens (JWT) for secure authorization, ensuring your data remains protected." projectLink="https://speakup-phi.vercel.app/" img={speak} techstack="Frontend- React.js, Tailwind Backend- HONO,Prisma Database- PostgreSQL"/>
...
This real-time chat application, leveraging both Express and WebSocket technologies, facilitates instant communication between users. It utilizes Express for handling HTTP requests and WebSocket for real-time, bidirectional communication. Users can connect, exchange messages, and view the number of connected users in real-time"
 projectLink="https://talkify-five.vercel.app/" img={talkify} techstack="Frontend- React.js Tailwind Backend- Express,TypeScript,WebSockets"/>
...
• Fractional Knapsack(Real life Knapsack) was solved using Genetic Algorithm using Core Java concepts" projectLink="https://github.com/rishitkamboj/Genetic-Algorithm/tree/main" img={genetic} techstack="Core JAVA"/>
